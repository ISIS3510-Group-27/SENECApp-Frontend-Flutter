...
class Rso {
  ...
  /// The organization's own accent, used for its icon tile, tags and CTA.
  final Color color;

  /// Basename of this organization's photo in `assets/images/orgs/`, without
  /// an extension. Resolved by `OrgImage`, which falls back to a gradient when
  /// the file has not been added yet.
  final String imageSlug;

  /// Officially recognised by Uniandes Student Affairs.
  final bool verified;
