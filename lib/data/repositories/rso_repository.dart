...
/// Single source of 'truth' for organization data (everything's basically burneeed).
///
...
/// database later is a change confined to this file.
class RsoRepository {
  const RsoRepository();
  ...
  /// The three organizations in the Discover carousel.
